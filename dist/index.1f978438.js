...
})({"aD562":[function(require,module,exports,__globalThis) {
...
},{}],"7elyk":[function(require,module,exports,__globalThis) {
...
bet20.addEventListener('click', ()=>{
    fetchData();
    if (currency >= 20) (0, _database.update)((0, _firebaseconfig.ref)((0, _firebaseconfig.database), 'Money-Balance'), {
        Chips: (0, _database.increment)(20),
        Credit: (0, _database.increment)(-20)
    });
    else Alert.innerHTML = "Sorry you dont have enough credit";
});
bet40.addEventListener('click', ()=>{
    fetchData();
    if (currency >= 40) (0, _database.update)((0, _firebaseconfig.ref)((0, _firebaseconfig.database), 'Money-Balance'), {
        Chips: (0, _database.increment)(40),
        Credit: (0, _database.increment)(-40)
    });
    else Alert.innerHTML = "Sorry you dont have enough credit";
});
bet120.addEventListener('click', ()=>{
    fetchData();
    if (currency >= 120) (0, _database.update)((0, _firebaseconfig.ref)((0, _firebaseconfig.database), 'Money-Balance'), {
        Chips: (0, _database.increment)(120),
...
const fetchData = ()=>__awaiter(void 0, void 0, void 0, function*() {
        ...
        try {
            ...
            const dataref4 = (0, _firebaseconfig.ref)((0, _firebaseconfig.database), 'Tokens/EtnaToken');
            const dataref5 = (0, _firebaseconfig.ref)((0, _firebaseconfig.database), 'Tokens/LOVE');
            const dataCurrency = (0, _firebaseconfig.ref)((0, _firebaseconfig.database), 'Money-Balance/Credit');
            const dataCurrency2 = (0, _firebaseconfig.ref)((0, _firebaseconfig.database), 'Money-Balance/Debt');
            const dataCurrency3 = (0, _firebaseconfig.ref)((0, _firebaseconfig.database), 'Money-Balance/Bet');
            const dataCurrency4 = (0, _firebaseconfig.ref)((0, _firebaseconfig.database), 'Money-Balance/Profit');
            const dataCurrency5 = (0, _firebaseconfig.ref)((0, _firebaseconfig.database), 'Money-Balance/Chips');
            const snapshot = yield (0, _firebaseconfig.get)(dataRef);
            if (snapshot.exists()) {
                const snap2 = yield (0, _firebaseconfig.get)(dataRef2);
                const data2 = snap2.val();
                laharlToken = data2;
                LaharlToken.innerHTML = laharlToken;
                const snap3 = yield (0, _firebaseconfig.get)(dataref3);
                const data3 = snap3.val();
                flonneToken = data3;
                FlonneToken.innerHTML = flonneToken;
                const snap4 = yield (0, _firebaseconfig.get)(dataref4);
                const data4 = snap4.val();
                etnaToken = data4;
                EtnaToken.innerHTML = etnaToken;
                const snap5 = yield (0, _firebaseconfig.get)(dataref5);
                const data5 = snap5.val();
                loveToken = data5;
                LOVEToken.innerHTML = loveToken;
                const snapcredit = yield (0, _firebaseconfig.get)(dataCurrency);
                const datacredit = snapcredit.val();
                currency = datacredit;
                Currency.innerHTML = 'Credit: ' + currency;
                const snapDebt = yield (0, _firebaseconfig.get)(dataCurrency2);
                const debtData = snapDebt.val();
                debt = debtData;
                Debt.innerHTML = 'Debt: ' + debt;
                const snapBet = yield (0, _firebaseconfig.get)(dataCurrency3);
                const betData = snapBet.val();
                trueSpend = betData;
                BetStake.innerHTML = 'Bet: ' + trueSpend;
                const snapProfit = yield (0, _firebaseconfig.get)(dataCurrency4);
                const ProfitData = snapProfit.val();
                const profits = ProfitData;
                Profit.innerHTML = 'Profits: ' + profits;
                const snapchips = yield (0, _firebaseconfig.get)(dataCurrency5);
...
Button.addEventListener('click', ()=>{
    ...
    if (chips != 0 && chips > 0 && trueSpend <= chips) {
        fetchData();
        (0, _database.update)((0, _firebaseconfig.ref)((0, _firebaseconfig.database), 'Money-Balance'), {
            Debt: (0, _database.increment)(-trueSpend)
        });
        (0, _database.update)((0, _firebaseconfig.ref)((0, _firebaseconfig.database), 'Money-Balance'), {
...
},{"firebase/database":"SJ4UY","./firebaseconfig":"914MJ"}],"SJ4UY":[function(require,module,exports,__globalThis) {
...
},{"6b38617303e2f7b9":"d5jf4","@firebase/app":"3AcPV","@firebase/component":"bi1VB","@firebase/util":"ePiK6","@firebase/logger":"fZmft","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"d5jf4":[function(require,module,exports,__globalThis) {
...
},{}],"3AcPV":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"d07263985281b344":"d5jf4","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gkKU3":[function(require,module,exports,__globalThis) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"914MJ":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "database", ()=>database);
parcelHelpers.export(exports, "ref", ()=>(0, _database.ref));
parcelHelpers.export(exports, "get", ()=>(0, _database.get));
var _app = require("firebase/app");
var _database = require("firebase/database");
...
},{"@firebase/app":"3AcPV","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["aD562","7elyk"], "7elyk", "parcelRequire94c2")
